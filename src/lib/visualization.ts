...
export class Polygon implements Visual {
  ...
  private getLinePoint(currentTicks: number): Point {
    const [line, ratio] = getDivRatio(currentTicks, this.tick)
